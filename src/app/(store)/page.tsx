...
export default function HomePage() {
  ...
  // 4. Parallel Data Preloading (Categories, Settings, Rates, Banners)
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* 3. Main Home Content with Smooth Fade-in */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3 pb-4">
          <Link
            href="/products"
            className="bg-white rounded-2xl border border-slate-200 p-3 flex flex-col items-center gap-2 shadow-sm hover:shadow-md transition-shadow"
          >
